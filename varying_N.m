...
for i2 = 1:length(u)
    ...
    avgber8(:,i2) = product * 0.5;
end
disp('DONE !!!');

semilogy(u_db, avgber, u_db, avgber1, u_db, avgber2, u_db, avgber3, u_db, avgber4, u_db, avgber5, u_db, avgber6, u_db, avgber7, u_db, avgber8);
legend('N = 1, case 1','N = 1, case 2','N = 1, case 3','N = 2, case 1','N = 2, case 2','N = 2, case 3', 'N = 3, case 1','N = 3, case 2','N = 3, case 3');
grid on;